...
function ScoutsLogEyeWire() {
    ...
    this.getRequest = function(msg, callback) {
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                SLEW.sendMessage(callback, this.responseText);
            }
        }
    ...
    this.getLocalizedStrings = function(data, callback) {
        ...
        xhr.onreadystatechange = function() {            
            if (xhr.readyState == 4) {
                ...
                SLEW.getLocalizationStrings(callback);
            }
        }
    ...
    this.getLocalizationStrings = function(callback) {
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var k in obj) {
                    SLEW.localizedStrings[k] = obj[k].message;
                }

                SLEW.getLocalizationStrings2(callback);
            }
        }
        ...
        if (url != "") {
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    SLEW.sendMessage(callback, SLEW.localizedStrings);
                }
            }
...
// Inject scouts.js into page
    ...
    s.src = chrome.extension.getURL('js/scouts.js');
